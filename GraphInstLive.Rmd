...
Watchlist<-c("ARCMITTAL","ANGGOLD","ANGLO","ANGLOPLAT","ASCENDIS","BATS","RMBH","HARMONY","ARM","BILLITON","CAPITEC","DRDGOLD","EXXARO","GFIELDS","GROUP-5","IMPLATS","KUMBAIO","LONMIN","NEWPALL","NEWSLV","NORTHAM","RAUBEX","SIBANYE","SOUTH32","TELKOM")
### Build ea of the xts datasets ###
mylist <- c(instLive,KeyIndixes,Metals,indi,Cons,Curr)
...
renderPlot({    
    chartSeries(data(), 
                ...
                name = input$indicator,theme = "white", 
                up.col = "blue",dn.col="red",
                 TA="addOBV(); addSMA(n = c(21,50,100), col = c('blue','red','black'));addMACD();addVo()")   
  })
```
...
renderPlot({    
    chartSeries(dataWal(), subset = paste(input$dtChoice7,"::",sep=""),name = input$wl,theme = "white", up.col = "blue",dn.col = "red",
               TA="addOBV(); addSMA(n = c(21,50,100), col = c('blue','red','black'));addMACD();addVo()")          
...
renderPlot({    
    chartSeries(to.weekly(dataWal()), 
                subset = ("2016-01::"),
                #subset = paste(input$dtChoice1,"::",sep=""),
                name = input$wl,theme = "white", up.col = "blue",
                dn.col = "red",
                TA="addOBV(); addSMA(n = c(5,21,50), col = c('blue','red','black'));addMACD();addVo()")  
  })
```
