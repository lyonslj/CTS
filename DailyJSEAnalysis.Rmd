...
```{r, fig.width=14,  fig.height= 8, message= FALSE, warning=FALSE, echo = FALSE, silent = TRUE}   
      ...
      lst <- c("GOLD-R","JSE-INDI","JH-ALSI40","JSE-FINI","JSE-GOLD","NIKKEI","JSE-PLAT","JSE-METL","UALSB","JSE-CONS","JSE-COAL","JSE-INDM","JSE-FOOD","JSE-PHAR","JSE-OILG","JSE-HEAL","JSE-BANK","JSE-TECH","JSE-TELE")
