...
lst <- lists$Indexes
RSC(lst,"Indexes","Weekly",to_console = FALSE)
...
lst <- unique(c(lists$RESI, lists$TELE, "BATS", lists$CHES, lists$TECH, "GOLD-R",  lists$GOLD, "SILV-R", "PLAT-R"))
RSC(lst,"TopList","Weekly",to_console = FALSE)
fnDyGraph(to_graph)                             # ---- Graph the top 20 from the heatmap
